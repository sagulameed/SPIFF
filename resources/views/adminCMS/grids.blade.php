    ...
    <div class="tab-bodycontent">
      <div class="tabs-bodypane tabs-bodypane-largegutter active" id="create-bodycontent">
            ...
            <div class="col-sm-4">
              <div class="contentHeaderSearch">
                <form action="{{url('adminCMS/searchElements')}}" method="POST">
                  {{ csrf_field() }}
                  <input type="text" id="searchinput" value="{{(!empty($tags)?$tags:'')}}" name="searchinput" required class="form-control" placeholder="Search grids: fashion,views,buildings...">
                  <input type="hidden" name="elementType" value="grids">
              ...
              <div class="col-md-5ths col-sm-4">
                <div class="imagebox-wrap">
                  <div class="imagebox-inner">
                    <img src="{{$grid->grid_name}}" style="height:180px;">
                    <!--<a href="javascript:deleteresource({{ $grid->id }}, '{{ url('adminCMS') }}/grids');" class="closemedium"><span class="icon-close"></span></a>-->
                    <a class="imagebox-footer" href="{{ url('adminCMS/editgrids') }}/{{$grid->id}}">Edit
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="contentFooter">
          <div class="row">
            {!! Form::open(array('url' => 'adminCMS/gridcreate', 'method'=>'POST', 'files'=>'true')); !!}
            <div class="col-sm-8">
              <div class="custom-file-upload">
                {!! Form::file('grids[]', array('multiple'=>true, 'data-btnlabel'=>'New Grid', "accept"=>".svg")) !!}
              </div>
            </div>

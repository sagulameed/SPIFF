    ...
    <div class="tab-bodycontent">
      <div class="tabs-bodypane tabs-bodypane-largegutter active" id="create-bodycontent">
            ...
            <div class="col-sm-4">
              <div class="contentHeaderSearch">
                <form action="{{url('adminCMS/searchElements')}}" method="POST">
                  {{ csrf_field() }}
                  <input type="text" id="searchinput" value="{{(!empty($tags)?$tags:'')}}" name="searchinput" required class="form-control" placeholder="Search frames: fashion,views,buildings...">
                  <input type="hidden" name="elementType" value="frames">
              ...
              <div class="col-md-5ths col-sm-4">
                <div class="imagebox-wrap">
                  <div class="imagebox-inner">
                    <img src="{{$frame->frame_name}}" style="height:180px;">
                    <a class="imagebox-footer" href="{{ url('adminCMS/editframes') }}/{{$frame->id}}">Edit
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="contentFooter">
          <div class="row">
            {!! Form::open(array('url' => 'adminCMS/framecreate', 'method'=>'POST', 'files'=>'true')); !!}
            <div class="col-sm-8">
              <div class="custom-file-upload">
                {!! Form::file('frames[]', array('multiple'=>true, 'data-btnlabel'=>'New Frame', "accept"=>".svg" )) !!}
              </div>
            </div>
